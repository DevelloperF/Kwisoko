		...
		<div class="col-sm-6">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<!--  Code to display the personnal details -->
				...
				<div class="panel-footer">
					<!--  Anchor to move to the edit of personnal details -->
		...
		<div class="col-sm-6">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<!--  Code to display the communication addrress -->
					<div class="text-center">
